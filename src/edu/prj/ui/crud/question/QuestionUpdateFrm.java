...
public class QuestionUpdateFrm extends JFrame{
	...
	public QuestionUpdateFrm(QuestionBean bean) {
		this.bean = bean;
		initUI();
		initFrame();
		configureCompents();
	...
	/**
	 * <p>Description: 配置题目ID信息面板</p>
	 * <p>Title: configurePnlQuestionID</p>
	 */
	private void configurePnlQuestionID() {
		pnlQuestionID.setLayout(new FlowLayout());
		pnlQuestionID.setPreferredSize(pnlDimension);
	}
	...
	/**
	 * <p>Description: 配置题目ID标签</p>
	 * <p>Title: configureLblQuestionID</p>
	 */
	private void configureLblQuestionID() {
		lblQuestionID.setFont(font);
		lblQuestionID.setPreferredSize(lblDimension);
	}
	...
	/**
	 * <p>Description: 配置题目ID文本框</p>
	 * <p>Title: configureTxtQuestionID</p>
	 */
	private void configureTxtQuestionID() {
		txtQuestionID.setFont(font);
		txtQuestionID.setPreferredSize(txtDimension);
	...
	private void installCompents() {
		...
		pnlQuestionID.add(lblQuestionID);
		pnlQuestionID.add(txtQuestionID);
	...
	private void btnSaveOnClickListener(ActionEvent e) {
		...
		if (question == null || question.isEmpty()) {
			...
			bean.setQType(cboQType.getSelectedIndex());
			...
			bean.setTag(tag);
			if (questionService.update(bean) > 0) {
	...
	private void setEditableTrue() {
		...
		cboQType.setEnabled(true);
		txtItemA.setEditable(true);
		txtItemB.setEditable(true);
		txtItemC.setEditable(true);
		txtItemD.setEditable(true);
		txtItemE.setEditable(true);
		txtItemF.setEditable(true);
	...
	private void refresh() {
		txtQuestionID.setText(bean.getQuestionID()+"");
		txtQuestion.setText(bean.getQuestion());
		cboQType.setSelectedIndex(bean.getQType());

...
public class TeacherShowInfoFrm extends JFrame{
	/** 内容面板 */
	...
	public TeacherShowInfoFrm(TeacherBean bean) {
		this.bean = bean;
		initUI();
		initFrame();
		configureCompents();
	...
	private void configureLblPicture() {
		...
		lblPicture.setPreferredSize(new Dimension(200, 300));
		String path = "picture/manager/admin.jpg";
		ImageIcon icon = new ImageIcon(path); 
		lblPicture.setIcon(scaleImage(icon));
	...
	private void configurePnlPicture() {
		pnlPicture.setPreferredSize(new Dimension(200, this.getHeight()));
	...
	/**
	 * <p>Description: 剪辑图片</p>
	 * <p>Title: scaleImage</p>
	 * @param icon
	 * @return
	 */

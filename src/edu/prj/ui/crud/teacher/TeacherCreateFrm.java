...
public class TeacherCreateFrm extends JFrame{
	/** 内容面板 */
	...
	private void btnSubmitOnClickListener(ActionEvent e) {
		...
		if (loginName == null || loginName.isEmpty()) {
			...
			return;
		} else if (teacherService.loadByLoginName(loginName) == null){
			...
			if (teacherService.insert(bean) > 0) {
				...
				this.teacherManagePnl.refreshData();
				this.dispose();
			} else {

...
public class TeacherMainFrm extends JFrame{
	...
	/** 试卷管理选项 */
	private JMenuItem menuItemPaperManage;
	/** 题库管理选项 */
	private JMenuItem menuItemQuestionManage;
	/** 成绩管理选项 */
	private JMenuItem menuItemScoreManage;
	/** 关于选项 */
	...
	private void initUI() {
		...
		menuTeach = new JMenu("教学");
		menuItemInfo = new JMenuItem("信息(I)");
		menuItemLogout = new JMenuItem("注销(L)");
		menuItemQuit = new JMenuItem("退出(Q)");
		menuItemSubjectManage = new JMenuItem("科目(S)");
		menuItemStudentManage = new JMenuItem("学生(N)");
		menuItemClassroomManage = new JMenuItem("班级(C)");
		menuItemPaperManage = new JMenuItem("试卷(J)");
		menuItemQuestionManage = new JMenuItem("题库(T)");
		menuItemScoreManage = new JMenuItem("成绩(R)");
	...
	private void configureMenuShortcuts() {
		...
		menuItemPaperManage.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_J,ActionEvent.CTRL_MASK));
		menuItemQuestionManage.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_T,ActionEvent.CTRL_MASK));
		menuItemScoreManage.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_R,ActionEvent.CTRL_MASK));
	...
	private void installCompents() {
		...
		menuManage.add(menuItemSubjectManage);
		menuManage.add(menuItemStudentManage);
		menuManage.add(menuItemClassroomManage);
		menuTeach.add(menuItemPaperManage);
		menuTeach.add(menuItemQuestionManage);
		menuTeach.add(menuItemScoreManage);
		
		// 添加功能菜单选项	
		menuFunction.add(menuManage);
		menuFunction.add(menuTeach);
	...
	private void installMenuListener() {
		...
		menuItemPaperManage.addActionListener(e->{
			menuItemPaperManageOnClickListener(e);
		});
		menuItemQuestionManage.addActionListener(e->{
			menuItemQuestionManageOnClickListener(e);
		});
		menuItemScoreManage.addActionListener(e->{
			menuItemScoreManageOnClickListener(e);
		});
	...
	private void menuItemInfoOnClickListener(ActionEvent e) {
		...
		refreshStatus();
		removePnl();
		TeacherInfoPnl teacherInfoPnl = new TeacherInfoPnl(bean);
		pnlNow = teacherInfoPnl;
		addPnl();
	}
	...
	/**
	 * <p>Description: 试卷管理点击事件监听器</p>
	 * <p>Title: menuItemPaperManageOnClickListener</p>
	 * @param e
	 */
	private void menuItemPaperManageOnClickListener(ActionEvent e) {
		lblStatusNow = "  当前状态：试卷管理";
		refreshStatus();
		removePnl();
		PaperManagePnl paperManagePnl = new PaperManagePnl();
		paperManagePnl.bean = this.bean;
		pnlNow = paperManagePnl;
		addPnl();
	}

	/**
	 * <p>Description: 题库管理点击事件监听器</p>
	 * <p>Title: menuItemQuestionManageOnClickListener</p>
	 * @param e
	 */
	private void menuItemQuestionManageOnClickListener(ActionEvent e) {
		lblStatusNow = "  当前状态：题库管理";
		refreshStatus();
		removePnl();
		QuestionManagePnl questionManagePnl = new QuestionManagePnl();
		questionManagePnl.bean = this.bean;
		pnlNow = questionManagePnl;
		addPnl();
	}
	
	/**
	 * <p>Description: 成绩管理点击事件监听器</p>
	 * <p>Title: menuItemScoreManageOnClickListener</p>
	 * @param e
	 */
	private void menuItemScoreManageOnClickListener(ActionEvent e) {
		lblStatusNow = "  当前状态：成绩管理";
		refreshStatus();
		removePnl();
		ScoreManagePnl scoreManagePnl = new ScoreManagePnl();
		scoreManagePnl.bean = this.bean;
		pnlNow = scoreManagePnl;
		addPnl();
	}
